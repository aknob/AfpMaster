...
class AfpSuperbase(object):
    ...
    def open_datei(self, Dateiname):
        if self.datei == None:
            self.datei = [AfpSbDatei(self.globals.get_mysql().get_dbname(Dateiname, False), Dateiname, self.globals.get_mysql().get_cursor(), self.debug)] 
            ...
            if self.is_open(Dateiname):
                ...
                self.datei.append(AfpSbDatei(self.globals.get_mysql().get_dbname(Dateiname, False), Dateiname, self.globals.get_mysql().get_cursor(), self.debug))
