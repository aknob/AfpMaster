...
class AfpDialog_EvClientEdit(AfpDialog):
    ...
    def attach_data(self, data, new = False, editable = False):
        ...
        if new and data.has_bulk_set() and self.sameRechData is None:
            print "AfpDialog_EvClientEdit.attach_data set sameRechNr"
    ...
    def load_into_data(self, complete = True):
        ...
        if data or self.change_preis or self.new:
            ...
            #print "AfpDialog_EvClientEdit.load_into_data data:", self.data.get_name(), data
            self.changed_text = []   
            self.preisnr = None
            self.preisprv = None
            self.ort = None
    ...
    def Pop_Alle(self):
        if self.sameRechLoad:
           ...
           # print "AfpDialog_EvClientEdit.Pop_Alle:", dummy, liste
            ...
            #print "AfpDialog_EvClientEdit.Pop_Alle:", self.sameRechData, liste, self.sameRechNr, self.sameRechIndex
            self.list_Alle.Clear()
