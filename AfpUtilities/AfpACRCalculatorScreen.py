...
class AfpACRScreen(AfpScreen):
    ...
    def InitWx(self):
        ...
        self.matrix_grid.SetSelectionMode(wx.grid.Grid.wxGridSelectRows)   
    ...
    def activate_config(self, config):
            ...
            if new and self.ranges:
                ...
                if "DATA_INVALID_LIST" in self.config or "ELIGIBLE_RELATIV_OTE_FACTOR" in self.config or "ELIGIBLE_OTE_MAXIMUM" in self.config: 
                    ...
                    self.people.set_eligibillity(data_list, ote_factor, ote_max)
            ...
            if new and self.people:
                ...
                cols = self.people.get_matrix_length(1)
